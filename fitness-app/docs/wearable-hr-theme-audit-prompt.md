...
Do a **full theme-conformance audit** of all the wearable-HR UI additions in the fitness-app iOS app. Goal: make sure every new surface follows the ARISE design system exactly — **color, fonts, buttons, highlights/glows, dividers, badges, spacing, nil-state degradation**. This is a polish/QA pass: find deviations, then fix them.
